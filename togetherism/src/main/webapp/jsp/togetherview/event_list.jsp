...
<c:if test="${empty eventlist}">
	...
	<c:when test="${not empty event_region}">
		<div class="alert alert-warning" role="alert" style="width: 640px;">
 			해당 지역에 이벤트가 없습니다! <a href="#" class="alert-link">만들러가기</a>
		</div>
	</c:when>
	<c:otherwise>
		<div class="alert alert-warning" role="alert" style="width: 640px;">
 			이벤트가 없습니다! <a href="#" class="alert-link">만들러가기</a>
		</div>
	</c:otherwise>
	</c:choose>
</c:if>
...
<div class="card mb-3 border-warning" style="width: 640px; height: 200px;">
  <div class="row no-gutters">
    ...
    <div class="col-md-8">
      <div class="card-body">
        <h5 class="card-title hidden"><a href="event_cont.do?club_num=${club_num}&event_num=${i.event_num}&eventPage=${eventPage}&state=cont">${i.event_title}</a></h5>
